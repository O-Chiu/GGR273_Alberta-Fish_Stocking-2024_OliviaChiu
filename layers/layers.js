...
//ol.proj.get("EPSG:3403").setExtent([-1983622.019781, 5412384.961752, 2673115.504815, 6659432.360869]);
var wms_layers = [];
...
var format_GGR273Lab2_ABWater_1 = new ol.format.GeoJSON();
var features_GGR273Lab2_ABWater_1 = format_GGR273Lab2_ABWater_1.readFeatures(json_GGR273Lab2_ABWater_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3403'});
var jsonSource_GGR273Lab2_ABWater_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GGR273Lab2_ABWater_1.addFeatures(features_GGR273Lab2_ABWater_1);
var lyr_GGR273Lab2_ABWater_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GGR273Lab2_ABWater_1, 
                style: style_GGR273Lab2_ABWater_1,
                popuplayertitle: "GGR273Lab2_ABWater",
                interactive: true,
                title: '<img src="styles/legend/GGR273Lab2_ABWater_1.png" /> GGR273Lab2_ABWater'
            });
...
lyr_AlbertaBoundary_0.setVisible(true);lyr_GGR273Lab2_ABWater_1.setVisible(true);lyr_FishStockingPoints_2.setVisible(true);
var layersList = [lyr_AlbertaBoundary_0,lyr_GGR273Lab2_ABWater_1,lyr_FishStockingPoints_2];
...
lyr_GGR273Lab2_ABWater_1.set('fieldAliases', {'HYDROUID': 'HYDROUID', 'NAME': 'NAME', 'RANK': 'RANK', 'PRUID': 'PRUID', });
lyr_FishStockingPoints_2.set('fieldAliases', {'DISTRICT': 'DISTRICT', 'WATERBODY': 'WATERBODY', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'SPECIES': 'SPECIES', 'GENOTYPE': 'GENOTYPE', 'STOCKED -': 'STOCKED -', 'STOCKING N': 'STOCKING N', 'PLANNED ST': 'PLANNED ST', 'MAa': 'MAa', 'Map Auth_1': 'Map Auth_1', 'Map Author': 'Map Author', 'Map Auth_2': 'Map Auth_2', 'Map Auth_3': 'Map Auth_3', 'MapAuthor': 'MapAuthor', 'NumStock': 'NumStock', });
...
lyr_GGR273Lab2_ABWater_1.set('fieldImages', {'HYDROUID': 'TextEdit', 'NAME': 'TextEdit', 'RANK': 'Range', 'PRUID': 'TextEdit', });
lyr_FishStockingPoints_2.set('fieldImages', {'DISTRICT': 'TextEdit', 'WATERBODY': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'SPECIES': 'TextEdit', 'GENOTYPE': 'TextEdit', 'STOCKED -': 'TextEdit', 'STOCKING N': 'TextEdit', 'PLANNED ST': 'TextEdit', 'MAa': 'TextEdit', 'Map Auth_1': 'TextEdit', 'Map Author': 'TextEdit', 'Map Auth_2': 'TextEdit', 'Map Auth_3': 'TextEdit', 'MapAuthor': 'TextEdit', 'NumStock': 'Range', });
...
lyr_GGR273Lab2_ABWater_1.set('fieldLabels', {'HYDROUID': 'no label', 'NAME': 'no label', 'RANK': 'no label', 'PRUID': 'no label', });
lyr_FishStockingPoints_2.set('fieldLabels', {'DISTRICT': 'inline label - visible with data', 'WATERBODY': 'inline label - visible with data', 'Latitude': 'hidden field', 'Longitude': 'hidden field', 'SPECIES': 'inline label - visible with data', 'GENOTYPE': 'inline label - visible with data', 'STOCKED -': 'hidden field', 'STOCKING N': 'hidden field', 'PLANNED ST': 'inline label - visible with data', 'MAa': 'hidden field', 'Map Auth_1': 'hidden field', 'Map Author': 'inline label - always visible', 'Map Auth_2': 'hidden field', 'Map Auth_3': 'hidden field', 'MapAuthor': 'hidden field', 'NumStock': 'inline label - always visible', });
